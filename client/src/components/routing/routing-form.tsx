    ...
    <div className="card-g2" data-testid="routing-form">
      <div className="flex items-center gap-3 mb-6">
        ...
        <div className="flex-1">
          <h2 className="text-2xl font-bold text-foreground">Auto-Routing AI-Only</h2>
          <p className="text-muted-foreground">Sistema intelligente Claude AI per classificazione automatica file</p>
