...
export default function AiFeatureConfigPanel() {
    ...
    <div className="space-y-6">
      ...
      <Tabs defaultValue="features" className="space-y-4">
        <TabsList className="bg-muted w-full flex-wrap h-auto gap-1 p-1">
          ...
          <TabsTrigger value="approval" className="flex-1 min-w-[100px] flex items-center justify-center gap-2 text-xs sm:text-sm">
            <Shield className="w-4 h-4" />
            <span className="hidden sm:inline">Auto-Approvazione</span>
            <span className="sm:hidden">Auto</span>
          </TabsTrigger>
          <TabsTrigger value="learning" className="flex-1 min-w-[100px] flex items-center justify-center gap-2 text-xs sm:text-sm">
